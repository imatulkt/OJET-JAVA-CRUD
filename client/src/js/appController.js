  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'dashboard', detail: { label: 'Create', iconClass: 'oj-icon-color-success oj-ux-ico-success-s oj-ux-icon-size-4x' } },
        { path: 'customers', detail: { label: 'View All', iconClass: 'oj-ux-ico-bar-chart' } },
      ...
      this.appName = ko.observable("Student Management");
      // User Info used in Global Navigation area
      this.userLogin = ko.observable("atul.kumar.tiwari@oracle.com");
